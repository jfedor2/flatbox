...
![Flatbox rev7.1 case variants](images/Flatbox-rev7.1-variants.png)
...
* [MCP23S17-E/SP](https://www.microchip.com/en-us/product/mcp23s17) SPI I/O expander
...
Make sure you get the MCP23S17 expander in DIP package. Observe pin 1 orientation when soldering.
...
![Flatbox rev7 unpopulated PCB](images/Flatbox-rev7.1-unpopulated-pcb.jpg)
...
To flash the firmware, download the [pgf-flatbox\_rev7.1-nrf52840.uf2](https://github.com/jfedor2/portable-gamepad-firmware/releases/latest/download/pgf-flatbox_rev7.1-nrf52840.uf2) file from the [Portable Gamepad Firmware](https://github.com/jfedor2/portable-gamepad-firmware) repository. Then connect the board to your computer using a USB cable and press the RESET button on the Xiao board twice quickly (the RESET button is really small, next to the USB port). A USB drive should appear on your computer. Copy the `pgf-flatbox_rev7.1-nrf52840.uf2` file to that drive.
...
![Flatbox rev7.1 exploded view of the case](images/Flatbox-rev7.1-exploded.png)
